...
public partial class Relatoriovendaspage
{
  ...
  void QuandoSelecionarUmItemNaLista(object sender, SelectedItemChangedEventArgs e)
  {
    ...
    var page = new Cadastrovendaspage();
    ...
    page.vendas = e.SelectedItem as Vendas;
    // Troca-se a página principal para a página que acabamos de criar
    Application.Current.MainPage = page;
  }

  void NovaVendaClicked(object sender, EventArgs e)
  {
    ...
    Application.Current.MainPage = new Cadastrovendaspage();
  }
